(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("86bad446-178e-4f9c-84b9-30e364902cfe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '86bad446-178e-4f9c-84b9-30e364902cfe' but no matching script tag was found.")
        }
